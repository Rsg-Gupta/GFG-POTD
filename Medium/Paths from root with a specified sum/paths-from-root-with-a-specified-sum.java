...
class Solution
{
    public static ArrayList<ArrayList<Integer>> printPaths(Node root, int sum)
    {
        ...
        findAllPaths(root,sum,ans,list,0);
        return ans;
    }
    
    public static void findAllPaths(Node root, int sum, ArrayList<ArrayList<Integer>> ans, ArrayList<Integer> list, int currSum )
    {
        ...
        findAllPaths(root.left,sum,ans,list,currSum);
         if(currSum==sum)  ans.add(new ArrayList<Integer>(list));
        findAllPaths(root.right,sum,ans,list,currSum);
        currSum-=root.data;
